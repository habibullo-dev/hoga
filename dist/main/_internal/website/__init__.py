...
def create_app(): #function that "creates" the app itself, and all its content.
    ...
    app.config['SECRET_KEY'] = 'DXM-IKWAERO' #Session and cookies encryptor. the string assigned can be anything you want, but must be kept SECRET outside of core dev team.
